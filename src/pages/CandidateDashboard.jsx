...
const MAIN_NAV = [
  ...
  { to: "/candidate/help", label: "Help", headerTitle: "Help & Support", icon: "help" },
  {
    ...
    children: [
      ...
      {
        to: "/candidate/demography/election",
        label: "Election",
        headerTitle: "Demography · Election",
        icon: "election",
      },
      { to: "/candidate/demography/news", label: "News", headerTitle: "Demography · News", icon: "news" },
      {
        to: "/candidate/demography/news-analysis",
        label: "News Analysis",
        headerTitle: "Demography · News Analysis",
        icon: "newsAnalysis",
      },
    ],
  },
  ...
  return (
    <DashboardShell loginPath="/candidate/login" portalLabel="CANDIDATE PORTAL" navItems={MAIN_NAV}>
      <Routes>
        ...
        <Route
          path="analysis"
          element={<CandidateSectionPage section="analysis" title="Analytics" subtitle="Constituency performance metrics and insights" />}
        />
        <Route
          path="technology"
          element={<CandidateSectionPage section="technology" title="Technology" subtitle="Campaign tech stack" />}
        />
        <Route
          path="content"
          element={<CandidateSectionPage section="content" title="Content" subtitle="Creative and messaging pipeline" />}
        />
        <Route
          path="distribution"
          element={<CandidateSectionPage section="distribution" title="Distribution" subtitle="Ground distribution channels" />}
        />
        <Route path="ads" element={<CandidateSectionPage section="ads" title="Ads" subtitle="Paid media performance" />} />
        <Route
          path="operation"
          element={<CandidateSectionPage section="operation" title="Operation" subtitle="Field operations tracker" />}
        />
        <Route
          path="consistency"
        ...
        <Route
          path="demography/news"
          element={<CandidateSectionPage section="demography-news" title="News" subtitle="Regional election news feed" />}
        />
        <Route
          path="demography/news-analysis"
          element={
            <CandidateSectionPage
              section="demography-news-analysis"
              title="News Analysis"
              subtitle="Narrative tracking and impact"
            />
          }
        />
      </Routes>
